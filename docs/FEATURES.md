...
- **opcore** - The frozen inline grammar: typed query, body projection, GraphQL grants, JMESPath postconditions, MCP proxy grants, and a named client. See [opcore-inline.md](opcore-inline.md).
